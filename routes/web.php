...
Route::get('thank-you', [CheckoutController::class, 'thankYouPaypal'])->name('checkout.thank-you');
Route::get('/checkout/cancel', [CheckoutController::class, 'cancel'])->name('checkout.cancel');
Route::get('/checkout/cancel-paypal', [CheckoutController::class, 'cancelPaypal'])->name('checkout.cancel-paypal');
...
Route::post('/create/order', [\App\Http\Controllers\PaypalController::class, 'create'])->name('paypal.order.create');
Route::post('/capture/order', [\App\Http\Controllers\PaypalController::class, 'capture'])->name('paypal.order.capture');
Route::get('/order/detail', [\App\Http\Controllers\PaypalController::class, 'details'])->name('paypal.order.details');
Route::any('/paypal/webhook',\App\Http\Controllers\PaypalWebhookController::class);
