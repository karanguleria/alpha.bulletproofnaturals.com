...
<section>
    <div class="container">
        ...
        <div class="text-center pt-2 pb-6">
            <h1 class="font-black text-4xl mb-3">Thank you for your message!</h1>
            <h4 class="text-2xl mb-2"> Our support team will be in touch with you as soon as possible.</h4>
        </div>
